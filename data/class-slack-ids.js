...
export const CLASS_SLACK_IDS = [
  ...
  // RESOLVED. Corrected from U0BLV30S7C6 to U0BLXBCK350 by Vee on 2026-09-10, and the
  // tracker matches it — she shows on Hard Regs with team lead Ethel Sarigumba. The
  // Build Notes "03 Join Test" tab still said "no row" on 2026-09-11 only because this
  // discovery job had not been re-run since the correction.
